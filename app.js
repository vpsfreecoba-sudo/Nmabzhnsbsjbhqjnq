...
const TIKTOK_SETTINGS = {
    ...
    //   - auto 1080p + remux copy + fuzz 5.56x + tkhd/mvhd +300
    // mode "midx" = signature api.midx.app (timescale 90000 + mdhd 0x55C00000)
    //   - fallback jika ingin mencoba signature midx
    injectEnabled: true,
    injectMode: "maska",
...
patchBtn.addEventListener("click", async () => {
    ...
    logMessage("=== EDITING NEWS HYBRID (Maska) — verified tidak ke-kompres ===", "info");
