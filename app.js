...
const TIKTOK_SETTINGS = {
    ...
    colorTrc: "bt709",
    colorSpace: "bt709",
    // Container inject (AST-style): inflate stsz/stts/stsc/stco dgn fake samples
    injectEnabled: true,
...
patchBtn.addEventListener("click", async () => {
    ...
    logMessage("FPS tetap asli — tidak diubah / tidak ditambah", "info");
    logMessage("Container fuzz: fake samples (stsz/stts/stsc/stco)", "info");
